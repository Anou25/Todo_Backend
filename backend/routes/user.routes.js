...
const { authenticateUser, authorizeAdmin, authorizeSelfOrAdmin } = require("../middleware/auth.middleware");
const {
    getAllUsers,
    getUserById,
    createUser,
...
router.put("/:id", authenticateUser, authorizeSelfOrAdmin, updateUser);
